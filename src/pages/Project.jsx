...
const CarouselLazy = lazy(async () => {
  await import('react-responsive-carousel/lib/styles/carousel.min.css')
  const m = await import('react-responsive-carousel')
  return { default: m.Carousel }
})
...
const projectData = {
  mutagenesis: {
    title: 'Mutagenesis',
    media: [
      { type: 'video', src: '/portfolio/mutagenesis.webm' },
      { type: 'image', src: '/portfolio/mutagenesis2.webp' },
      { type: 'image', src: '/portfolio/mutagenesis3.webp' },
      { type: 'image', src: '/portfolio/mutagenesis4.webp' }
    ],
    duration: '6 months',
    engine: 'Unity (C#)',
    introduction: (
  ...
  rhyver: {
    title: 'Rhyver',
    media: [
      { type: 'video', src: '/portfolio/rhyver.webm' },
      { type: 'image', src: '/portfolio/rhyver2.webp' },
      { type: 'image', src: '/portfolio/rhyver3.webp' }
    ],
    duration: '6 Months',
    engine: 'Unity (C#)',
    introduction: (
  ...
  lowertones: {
    title: 'Lowertones',
    media: [
      { type: 'video', src: '/portfolio/lowertones.webm' },
      { type: 'image', src: '/portfolio/lowertones2.webp' },
      { type: 'image', src: '/portfolio/lowertones3.webp' }
    ],
    duration: '10 Weeks',
  ...
  rudawful: {
    title: 'Rudawful',
    media: [
      { type: 'video', src: '/portfolio/rudawful.webm' },
      { type: 'image', src: '/portfolio/rudawful2.webp' },
      { type: 'image', src: '/portfolio/rudawful3.webp' }
    ],
    duration: '1 Week',
    engine: 'Unity (C#)',
    introduction: (
  ...
  "brie-afraid": {
    title: 'Brie Afraid',
    media: [
      { type: 'video', src: '/portfolio/brie-afraid.webm' },
      { type: 'image', src: '/portfolio/brie-afraid2.webp' },
      { type: 'image', src: '/portfolio/brie-afraid3.webp' }
    ],
    duration: '1 Week',
    engine: 'Unity (C#)',
    introduction: (
...
export default function Project() {
  ...
  // Lazy-load KaTeX only once on mount if the project uses math
  useEffect(() => {
    let mounted = true
    import('react-katex').then((m) => {
      if (!mounted) return
      setInlineMath(() => m.InlineMath)
      setBlockMath(() => m.BlockMath)
      setMathLoaded(true)
    })
    ...
    <div className="project-page">
      ...
      <div className="carousel-container">
        <Suspense fallback={<div className="carousel-placeholder" />}>
          <CarouselLazy showIndicators={true} showArrows={true} showStatus={false} showThumbs={false}>
      ...
      {mathLoaded && InlineMath && BlockMath
        ? project.body({ InlineMath, BlockMath })
        : <p>Loading content...</p>
      }
