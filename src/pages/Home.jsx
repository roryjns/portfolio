...
export default function Home() {
  ...
  const highlights = [
    { src: '/portfolio/mutagenesis.gif', title: 'Mutagenesis' },
  ];

  const projects = [
    {
      title: 'Rhyver',
      thumbnail: '/portfolio/rhyver.gif',
      duration: '6 Months',
      engine: 'Unity (C#)',
      teamSize: '1',
    ...
    {
      title: 'Lowertones',
      thumbnail: '/portfolio/lowertones.gif',
      duration: '10 Weeks',
      engine: 'Angular',
      teamSize: '7',
    ...
    {
      title: 'Rudawful',
      thumbnail: '/portfolio/rudawful.gif',
      duration: '1 Week',
      engine: 'Unity (C#)',
      teamSize: '1',
    ...
    {
      title: 'Brie Afraid',
      thumbnail: '/portfolio/brie-afraid.gif',
      duration: '1 Week',
      engine: 'Unity (C#)',
      teamSize: '3',
    ...
    <>
      <section id="about" className="about-section">
        <div className="about-content">
          <img src="/portfolio/profile-pic.jpg" alt="Profile pic" className="profile-pic" />
      ...
      <section id="highlights">
        ...
        <div className="carousel-container">
          <Carousel autoPlay infiniteLoop interval={2000} showIndicators={false} showArrows={true} showStatus={false} showThumbs={false} stopOnHover>
            {highlights.map((highlight, index) => (
              <div key={index} className="card">
                <Link to={`/${highlight.title.toLowerCase().replace(/\s+/g, '-')}`}>
                  <img className="card-img" src={highlight.src} alt={highlight.title} />
